      ...
      <Flex minH={"100vh"} align={"center"} justify={"center"}>
        ...
        >
          ...
          <Box rounded={"lg"} boxShadow={"lg"} p={8}>
            <form method="POST" onSubmit={(e) => handleAddCourse(e)}>
              <Stack spacing={4}>
                ...
                <FormControl id="teacher">
                  ...
                  <Select
                    ...
                    fontWeight={"bold"}
                  >
                    <option value="Khan Sir & Team">Khan Sir & Team</option>
                    <option value="Khan Sir">Khan Sir</option>
                    <option value="Arjun Sir">Arjun Sir</option>
                  </Select>
                </FormControl>
